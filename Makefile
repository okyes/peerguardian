...
install:
	...
	install -m 644 blockcontrol.defaults blockcontrol.lib $(DESTDIR)/usr/lib/blockcontrol
	install -m 644 allow.p2p blockcontrol.conf blocklists.list iptables-custom-insert.sh iptables-custom-remove.sh $(DESTDIR)/etc/blockcontrol
